...
const apiUrl = process.env.API_URL || (awsBaseUrl === 'http://localhost' ? 'http://localhost:3000' : `${awsBaseUrl}:3000`);
const apiBookingUrl = process.env.API_BOOKING_SERVICE_URL || (awsBaseUrl === 'http://localhost' ? 'http://localhost:4000' : `${awsBaseUrl}:8080`);
